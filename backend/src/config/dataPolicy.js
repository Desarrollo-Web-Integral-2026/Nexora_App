const DATA_POLICY = {
  ...
  arco_cancelled_accounts: {
    finalidad: 'Aplicar el periodo de gracia previo a la anonimización definitiva de cuentas canceladas',
    retention: '30 días desde la solicitud de cancelación',
    retentionDays: 30,
  },
}
